...
;"use strict";
var prefetches = new Set, prefetchElement = document.createElement('link'), isSupported = prefetchElement.relList && prefetchElement.relList.supports && prefetchElement.relList.supports('prefetch') && window.IntersectionObserver && 'isIntersecting'in IntersectionObserverEntry.prototype, allowQueryString = 'instantAllowQueryString'in document.body.dataset, allowExternalLinks = 'instantAllowExternalLinks'in document.body.dataset, useWhitelist = 'instantWhitelist'in document.body.dataset, mousedownShortcut = 'instantMousedownShortcut'in document.body.dataset, DELAY_TO_NOT_BE_CONSIDERED_A_TOUCH_INITIATED_ACTION = 1111, delayOnHover = 65, useMousedown = !1, useMousedownOnly = !1, useViewport = !1, mouseoverTimer, lastTouchTimestamp, intensity, milliseconds, eventListenersOptions, triggeringFunction;
'instantIntensity'in document.body.dataset && (intensity = document.body.dataset.instantIntensity,
intensity.substr(0, 'mousedown'.length) == 'mousedown' ? (useMousedown = !0,
intensity == 'mousedown-only' && (useMousedownOnly = !0)) : intensity.substr(0, 'viewport'.length) == 'viewport' ? navigator.connection && (navigator.connection.saveData || navigator.connection.effectiveType && navigator.connection.effectiveType.includes('2g')) || (intensity == "viewport" ? document.documentElement.clientWidth * document.documentElement.clientHeight < 45e4 && (useViewport = !0) : intensity == "viewport-all" && (useViewport = !0)) : (milliseconds = parseInt(intensity),
isNaN(milliseconds) || (delayOnHover = milliseconds))),
isSupported && (eventListenersOptions = {
    capture: !0,
    passive: !0
},
useMousedownOnly || document.addEventListener('touchstart', touchstartListener, eventListenersOptions),
useMousedown ? mousedownShortcut || document.addEventListener('mousedown', mousedownListener, eventListenersOptions) : document.addEventListener('mouseover', mouseoverListener, eventListenersOptions),
mousedownShortcut && document.addEventListener('mousedown', mousedownShortcutListener, eventListenersOptions),
useViewport && (window.requestIdleCallback ? triggeringFunction = function(a) {
    requestIdleCallback(a, {
        timeout: 1500
    })
}
: triggeringFunction = function(a) {
    a()
}
,
...
function mousedownShortcutListener(a) {
    ...
    if (performance.now() - lastTouchTimestamp < DELAY_TO_NOT_BE_CONSIDERED_A_TOUCH_INITIATED_ACTION)
        return;
    if (b = a.target.closest('a'),
    a.which > 1 || a.metaKey || a.ctrlKey)
        return;
    if (!b)
        return;
    ...
    (function() {
        ...
        LightGallery.prototype.toggleMaximize = function() {
            ...
            this.getElementById('lg-maximize').on('click.lg', function() {
                ...
                $('.inline-gallery-carousel').parents('section').toggleClass('multi-assests');
...
//# sourceMappingURL=lightgallery.umd.js
...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self,
    global.lgVimeoThumbnail = factory());
}(this, (function() {
    'use strict';
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    ...
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < dynamicGallery.galleryItems.length))
                            return [3 /*break*/
                            , 5];
                        ...
                        if (!slideVideoInfo.vimeo)
                            ...
                            , 4];
                        return [4 /*yield*/
                        , fetch('https://vimeo.com/api/oembed.json?url=' + encodeURIComponent(item.src))];
                    case 2:
                        response = _a.sent();
                        return [4 /*yield*/
                        , response.json()];
    ...
    (function() {
        ...
        MediumZoom.prototype.init = function() {
            ...
            this.core.LGel.on(lGEvents.beforeOpen + ".medium", function() {
                _this.core.$backdrop.css('background-color', _this.core.galleryItems[_this.core.index].lgBackgroundColor || _this.settings.backgroundColor);
            });
...
function _objectSpread(c) {
    for (var a = 1, b; a < arguments.length; a++)
        ...
        a % 2 ? ownKeys(Object(b), !0).forEach(function(a) {
            _defineProperty(c, a, b[a])
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(c, Object.getOwnPropertyDescriptors(b)) : ownKeys(Object(b)).forEach(function(a) {
            Object.defineProperty(c, a, Object.getOwnPropertyDescriptor(b, a))
        });
    return c
}
function _defineProperty(b, a, c) {
    return a = _toPropertyKey(a),
...
function _toPropertyKey(b) {
    var a = _toPrimitive(b, "string");
    return _typeof(a) === "symbol" ? a : String(a)
}
function _toPrimitive(a, d) {
    var b, c;
    if (_typeof(a) !== "object" || a === null)
        return a;
    if (b = a[Symbol.toPrimitive],
    b !== void 0) {
        if (c = b.call(a, d || "default"),
        _typeof(c) !== "object")
            return c;
...
$lgInlineContainer = document.getElementById('inline-gallery-carousel');
if($lgInlineContainer != null){
    var dynamicEl = [];
    var galleryitem = document.getElementsByClassName("gallery-item");
    let galleryData ;
    for (var i=0; i< galleryitem.length; i++){
        if(galleryitem[i].classList.contains("mp4Video")){
            galleryData = {
                video: {
                    source: [
                      {
                        src: galleryitem[i].getAttribute('data-src'),
                        type: 'video/mp4',
                      },
                    ],
                  ...
                  alt: galleryitem[i].getAttribute('data-alt'),
                  responsive: galleryitem[i].getAttribute('data-responsive-src'),
                  poster:galleryitem[i].getAttribute('data-poster'),
                  thumb:galleryitem[i].getAttribute('data-thumb-src'),
                  subHtml: '<div class="lightGallery-captions">\n <h4>'+galleryitem[i].getAttribute('data-title')+'</h4> </div>'
                }
        }else{
            galleryData = {
                src: galleryitem[i].getAttribute('data-src'),
       ...
       dynamicEl.push(galleryData);
    }

}
$lgInlineContainer && (inlineGallery = window.lightGallery($lgInlineContainer, _objectSpread(_objectSpread({
    ...
    slideDelay: 400,
    share:false,
    plugins: [lgZoom, lgShare, lgAutoplay, lgThumbnail,lgVideo],
